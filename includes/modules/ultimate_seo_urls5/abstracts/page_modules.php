<?php
  ...
  */
  abstract class aPage_Modules {
    ...
    */
      protected function returnFinalLinks( $uri ) {
...
//          return htmlspecialchars( utf8_encode( $link ) );
    ...
    */
    protected function getDependencyKey() {
      ...
      protected function setCollectorQuery( array $replace_with ) {
          $this->query = str_replace( $this->dependencies[$this->getDependencyKey()]['to_replace'], $replace_with, $this->dependencies[$this->getDependencyKey()]['collector_query'] );
      }
    ...
    */
    protected function linkText( $array_of_texts ) {
      if (is_array($array_of_texts)){
          $link_text = array();
