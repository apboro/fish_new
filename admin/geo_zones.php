...
?>
              <tr>
                <td colspan="3"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $zones_split->display_count($zones_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['spage'], TEXT_DISPLAY_NUMBER_OF_COUNTRIES); ?></td>
