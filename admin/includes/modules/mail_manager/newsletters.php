...
//		$mail_query = tep_db_query("select customers_firstname, customers_lastname, customers_email_address, customers_newsletter, mmstatus from " . TABLE_CUSTOMERS . " where customers_newsletter = '1' and mmstatus = '0' ");
        $mail_query = tep_db_query("select customers_firstname, customers_lastname, customers_email_address, customers_newsletter, mmstatus,customers_uuid,customers_id from " . TABLE_CUSTOMERS . " where customers_newsletter = '1' and mmstatus = '0' ");
