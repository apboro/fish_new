...
?>
	<div class="review_box">
  		<span class="title"><?php echo TABLE_HEADING_SHIPPING_ADDRESS; ?></span>

          <div class="contentText">
            <div class="mj-product_infoleft">
              <span class="add_title"><?php echo TITLE_SHIPPING_ADDRESS; ?></span>
...
?>
   	<div id="checkoutNewAddress">
        <div class="review_box">
        	<div class="content_box">
  				<span class="title"><?php echo TABLE_HEADING_NEW_SHIPPING_ADDRESS; ?></span>
                ...
                <div class="contentText">
                    ...
                    ?>
          	<?php echo tep_draw_hidden_field('action', 'submit') . tep_draw_button(IMAGE_BUTTON_CONTINUE, 'triangle-1-e', null, 'primary'); ?>
          </div>
</div>
