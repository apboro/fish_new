...
?>
              <tr>
                <td colspan="5"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $rates_split->display_count($rates_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_TAX_RATES); ?></td>
