...
?>
<div class="contentContainer" id="address_book">
    ...
    <div class="review_box">
    	<span class="title"><?php echo ADDRESS_BOOK_TITLE; ?></span>
        <?php
        ...
        <div class="content_box">
      		<span class="title">
					<?php echo tep_output_string_protected($addresses['firstname'] . ' ' . $addresses['lastname']); ?></strong><?php if ($addresses['address_book_id'] == 
            ...
            <span class="link_button">
            	<?php echo tep_draw_button(SMALL_IMAGE_BUTTON_EDIT, 'document', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'edit=' . $addresses['address_book_id'], 'SSL')); ?>
            </span>
            <span class="link_button">
				<?php echo tep_draw_button(SMALL_IMAGE_BUTTON_DELETE, 'trash', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, 'delete=' . $addresses['address_book_id'], 'SSL')); ?>
    		</span>
    	</div>
    ...
    <div class="buttonSet">
		...
		?>
    	<span class="buttonAction link_button">
			<?php echo tep_draw_button(IMAGE_BUTTON_ADD_ADDRESS, 'home', tep_href_link(FILENAME_ADDRESS_BOOK_PROCESS, '', 'SSL'), 'primary'); ?>
        </span>
		<?php
  			}
		?>
