...
/* CDS Patch. 12. EOF */
    ...
    $loginboxcontent = "
			...
			<a style=\" font-size: 15px; \" href=\"" . tep_href_link(FILENAME_PASSWORD_FORGOTTEN, '', 'SSL') . "\">" . HEADER_TITLE_PASSWORD_FORGOTTEN . "</a>
			</td>
      	    </tr>
		    <tr>
        		<td align=\"center\" class=\"boxText\">
			<a style=\" font-size: 15px; \" href=\"" . tep_href_link(FILENAME_CREATE_ACCOUNT, '', 'SSL') . "\">" . HEADER_TITLE_CREATE_ACCOUNT . "</a>
			</td>
      	    </tr>
            </form>
            </table>
