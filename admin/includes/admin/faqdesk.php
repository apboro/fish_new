...
<table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $products_split->display_count($products_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_FAQS); ?></td>
