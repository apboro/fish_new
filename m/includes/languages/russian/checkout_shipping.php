...
define('ERROR_NO_SHIPPING_AVAILABLE_TO_SHIPPING_ADDRESS', 'Доставка в настоящее время не доступны для выбранного адреса доставки. Пожалуйста, выберите или создайте новый адрес доставки на использование с вашей покупкой.');
?>