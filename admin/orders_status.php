...
<!-- body_text //-->
    <td width="100%" valign="top"><table class="table-padding-2">
      ...
      <tr>
        <td valign="top"><table class="table-padding-0">
          <tr>
...
?>
              <tr>
                <td colspan="2"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $orders_status_split->display_count($orders_status_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_ORDERS_STATUS); ?></td>
