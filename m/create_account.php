...
// needs to be included earlier to set the success message in the messageStack
  ...
  if (isset($HTTP_POST_VARS['action']) && ($HTTP_POST_VARS['action'] == 'process') && isset($HTTP_POST_VARS['formid']) && ($HTTP_POST_VARS['formid'] == $sessiontoken)) {
    ...
    if ((strlen($email_address) < ENTRY_EMAIL_ADDRESS_MIN_LENGTH)  or strpos($email_address, 'yahoo') or strpos($email_address, '.de') or strpos($email_address, '.at') or strpos($email_address, '.ch')){
      $error = true;
...
<div class="contentContainer">
  <div>
   ...
   <h4 class="acc_trigger"><?php echo CATEGORY_PERSONAL; ?></h4>
...
?>
  ...
  <h4 class="acc_trigger"><?php echo CATEGORY_COMPANY; ?></h4>
...
?>
  ...
  <h4 class="acc_trigger"><?php echo CATEGORY_ADDRESS; ?></h4>

  <div class="contentText acc_container">
    <table border="0" cellspacing="2" cellpadding="2" width="100%">
      <tr>
        <td class="fieldKey"><?php echo ENTRY_STREET_ADDRESS; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('street_address')   ?></td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('suburb')  ?></td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue"><?php echo tep_draw_input_field('postcode')  ?></td>
      </tr>
      <tr>
        <td class="fieldKey"><?php echo ENTRY_CITY; ?></td>
        <td class="fieldValue"><?php echo tep_draw_input_field('city')  ?></td>
      </tr>
...
?>
      ...
      <tr>
        ...
        <td class="fieldValue country_select"><?php echo tep_get_country_list('country')   ?></td>
      </tr>
    </table>
  </div>

  <h4 class="acc_trigger"><?php echo CATEGORY_CONTACT; ?></h4>
  ...
  <h4 class="acc_trigger"><?php echo CATEGORY_PASSWORD; ?></h4>
