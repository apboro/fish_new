...
if ($metaData ['keywords']) $meta_keywords = $common_meta_keywords . " " . $metaData ['keywords'];
if ($metaData ['description']) $meta_description = $common_meta_description . " " . $metaData ['description'];
...
if ($metaData ['title']) $meta_title = $common_meta_title . " " . $metaData ['title'];
if ($metaData ['keywords']) $meta_keywords = $metaData ['keywords']; 
if ($metaData ['description']) $meta_description = $metaData ['description']; 
