    ...
    function execute() {
      ...
      if (isset($HTTP_GET_VARS['products_id'])) {
        ...
        if (tep_db_num_rows($manufacturer_query)) {
          ...
          if (tep_not_null($manufacturer['manufacturers_image'])) $manufacturer_info_string .= '<tr><td align="center" colspan="2">' . tep_image(DIR_WS_IMAGES . $manufacturer['manufacturers_image'], $manufacturer['manufacturers_name']) . '</td></tr><tr><td>&nbsp;</td></tr>';
          if (tep_not_null($manufacturer['manufacturers_url'])) $manufacturer_info_string .= '<tr><td valign="top" align="center"><a href="' . tep_href_link(FILENAME_REDIRECT, 'action=manufacturer&manufacturers_id=' . $manufacturer['manufacturers_id']) . '" target="_blank">' . sprintf(MODULE_BOXES_MANUFACTURER_INFO_BOX_HOMEPAGE, $manufacturer['manufacturers_name']) . '</a></td></tr><tr><td>&nbsp;</td></tr>';
          $manufacturer_info_string .= '<tr><td valign="top" align="center"><a href="' . tep_href_link(FILENAME_DEFAULT, 'manufacturers_id=' . $manufacturer['manufacturers_id']) . '">View ' . MODULE_BOXES_MANUFACTURER_INFO_BOX_OTHER_PRODUCTS . '</a></td></tr>' .
                                       '</table>';

          $data = '<div class="ui-widget infoBoxContainer mj-manufacturerinfo">' .
