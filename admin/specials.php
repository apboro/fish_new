...
//----changed by iHolder    
$filter_string=tep_db_input($_REQUEST['filter_id']);
                                        ...
                                        <td class="main">
                                            ...
                                            if ( ($_GET['action'] == 'new') && isset($_GET['prodID']) ) {
                                                ...
                                                if (strlen($filter_string)>0){
                                                    $filter_query=' and (upper(p.products_model) like upper("%'.$filter_string.'%") or upper(pd.products_name)  like upper("%'.$filter_string.'%"))';
                                                }else{$filter_query='';}
                                            $search_form='<div style="margin:10px;border:1px solid black;"><table border="0"><tr><td colspan="2">Фильтр:'.$filter_string.'</td></tr>';
                                            $search_form.='<tr><td><input name="filter_id"></td><td><input type="submit" value="Отобрать"></td></tr></table></div>';
                                            echo (isset($sInfo->products_name)) ? $sInfo->products_name . ' <small>(' . $currencies->format($sInfo->products_price) . ')</small>' : $search_form.tep_draw_products_pull_down('products_id', 'style="font-size:10px"', $specials_array,$filter_query,60); echo tep_draw_hidden_field('products_price', (isset($sInfo->products_price) ? $sInfo->products_price : ''));
                      ...
                      echo " )";?>
                                        ...
                                        <tr>
                                            <td colspan="4"><table border="0" width="100%" cellpadding="0"cellspacing="2">
                                                    <tr>
                                                        <td class="smallText top-valign"><?php echo $specials_split->display_count($specials_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_SPECIALS); ?></td>
