...
?>
              <tr>
                <td class="smallText" colspan="7"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $affiliate_clickthroughs_split->display_count($affiliate_clickthroughs_numrows,  MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_CLICKS); ?></td>
