...
<div class="contentContainer" id="checkout_payment_address">
    ...
    <div class="review_box">
    	<span class="title"><?php echo TABLE_HEADING_PAYMENT_ADDRESS; ?></span>
        <div class="contentText">
        	<div class="mj-product_infoleft">
              	<span class="add_title"><?php echo TITLE_PAYMENT_ADDRESS; ?></span>
