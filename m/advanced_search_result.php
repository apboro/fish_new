...
// EOF manufacturers descriptions
    ...
    $categories_sql = "SELECT p2c.categories_id " . $from_str . str_replace("group by p.products_id" ,"group by p2c.categories_id",$where_str);
	...
	if  ($listing_split->number_of_rows <= 0)
			{
				...
				//echo "нету нихера, вызывай яндекс";
  ...
  <div class="buttonSet">
    <span class="link_button"><?php echo tep_draw_button(IMAGE_BUTTON_BACK, 'triangle-1-w', tep_href_link(FILENAME_ADVANCED_SEARCH, tep_get_all_get_params(array('sort', 'page')), 'NONSSL', true, false)); ?></span>
  </div>
</div>
</div>
<?php
