...
?>
              <tr>
                <td colspan="4"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $countries_split->display_count($countries_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_COUNTRIES); ?></td>
