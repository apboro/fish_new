...
?>
      ...
      <tr>
		...
		<table border=0>
		<tr><td class="main">Скидка 1(<<?php echo  $sInfo->sale_quantity;?>)</td><td>
		<?php echo tep_draw_input_field('deduction', $sInfo->sale_deduction_value, 'size="8"');?>
		</td></tr>
        	<tr><td class="main">Скидка 2(> <?php echo  $sInfo->sale_quantity; ?>)</td><td>
		<?php echo tep_draw_input_field('deduction_value_2', $sInfo->sale_deduction_value_2, 'size="8"'); ?>
        	</td></tr>
		<tr><td class="main">Количество</td><td>
		<?php echo tep_draw_input_field('deduction_quantity', $sInfo->sale_quantity, 'size="8"');?><br>
		</td></tr>
		<tr><td class="main"><?php echo TEXT_SALEMAKER_DEDUCTION_TYPE;?></td><td>
