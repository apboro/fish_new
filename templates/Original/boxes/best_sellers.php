  ...
  new infoBoxHeading($info_box_contents, false, false, tep_href_link(FILENAME_BEST_SELLERS));
    ...
    while ($best_sellers = tep_db_fetch_array($best_sellers_query)) {
      ...
      $info_box_contents[] = array('align' => 'left',
                                   'text'  => tep_row_number_format($rows) . '.&nbsp;<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $best_sellers['products_id'], 'NONSSL') . '"'.AddBlank().'>' . $best_sellers['products_name'] . '</a>');
    }
