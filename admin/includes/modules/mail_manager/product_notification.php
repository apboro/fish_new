...
//--></script>';
	...
	$products_array = array();
	 ...
	 $global_button = '<script language="javascript"><!--' . "\n" .
      ...
      echo '<tr><td><form name="notifications" action="' . tep_href_link(FILENAME_MM_BULKMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $HTTP_GET_VARS['nID'] . '&action=confirm') . '" method="post" onSubmit="return selectAll(\'notifications\', \'chosen[]\')"><table class="table-padding-2">' . "\n" .
                                 '  <tr>' . "\n" .
