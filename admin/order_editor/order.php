...
*/
  ...
  class manualOrder {
    ...
    function query($order_id) {
      ...
      $index = 0;
      $orders_products_query = tep_db_query("select orders_products_id, products_id, products_name, products_model, products_price, products_tax, products_quantity, zakaz_price, final_price from " . TABLE_ORDERS_PRODUCTS . " where orders_id = '" . (int)$order_id . "' order by orders_products_id");
      ...
      while ($orders_products = tep_db_fetch_array($orders_products_query)) {
		...
		'zakaz_price' => $orders_products['zakaz_price'],
