...
$insert_image_three = '
<table border="0" cellspacing="0" cellpadding="0" id="newdesk-list">
	<tr>
		<td>
<a href="' . tep_href_link(FILENAME_NEWSDESK_INFO, 'newsdesk_id=' . $newsdesk_var['newsdesk_id']) . '">' . tep_image(DIR_WS_IMAGES . 
...
$insert_readmore = '<a class="infoBoxContents" href="' . tep_href_link(FILENAME_NEWSDESK_INFO, 'newsdesk_id=' . $newsdesk_var['newsdesk_id']) . '">[' . TEXT_NEWSDESK_READMORE . 
']</a>';
}
...
$insert_date = '- <i>' . tep_date_long($newsdesk_var['newsdesk_date_added']) . '</i>';
		...
		$info_box_contents[$row] = array(
			'align' => 'left',
			'params' => 'class="infoBoxContents" valign="top"',
			'text' => '
<table class="table-spacing-3">
	<tr class="newdesk-title">
		<td class="infoBoxContents" colspan="2">
' . $insert_headline . $insert_date . '
		</td>
		<td class="infoBoxContents viewcount" colspan="2">' . $insert_viewcount . '</td>
	</tr> 
</table>
...
<table class="table-spacing-3">
	<tr>
		<td class="infoBoxContents">' . $insert_summary . '</td>
	</tr>
	<tr>
		<td>' . tep_draw_separator('pixel_trans.gif', '100%', '10') . '</td>
	</tr>
	<tr>
		<td class="infoBoxContents">' . $insert_readmore . '</td>
	</tr>
</table>
