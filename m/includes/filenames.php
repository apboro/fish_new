...
// define the filenames used in the project
  ...
  define('FILENAME_TERMS_CONDITION', 'terms_condition.php');
  define('FILENAME_DELIVERY_INFORMATION', 'delivery_information.php');
  define('FILENAME_AFFILIATES', 'affiliates.php');
  define('FILENAME_REFUND_POLICY', 'refund_policy.php');
  define('FILENAME_TYPOGRAPHY', 'typography.php');
  define('FILENAME_SITEMAP', 'sitemap.php');
  define('FILENAME_LAYOUT', 'layout.php');
  define('FILENAME_STORE_FINDER', 'store_finder.php');
