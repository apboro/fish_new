...
?>
              <tr>
                <td colspan="3">
                	<table class="table-padding-2">
                  	<tr>
                    	<td class="smallText top-valign"><?php echo $templates_split->display_count($templates_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $HTTP_GET_VARS['page'], TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS); ?></td>
                  	...
                  	<tr>
                    	<td align="right" colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_MM_TEMPLATES, 'action=new') . '">' . tep_image_button('button_new_newsletter.gif', IMAGE_NEW_NEWSLETTER) . '</a>'; ?></td>
                  	</tr>
                	</table>
                </td>
              </tr>
