...
//
    function credit_selection() {
      ...
      if (MODULE_ORDER_TOTAL_INSTALLED) {
        $header_string = '<tr>' . "\n";
        $header_string .= '   <td><table class="table-padding-2">' . "\n";
        $output1_string .= '      <tr>' . "\n";
        ...
        $header_string .= '     <tr class="infoBoxContents"><td><table class="table-padding-2">' ."\n";
       $header_string .= '       <tr><td width="10">' .  tep_draw_separator('pixel_trans.gif', '10', '1') .'</td>' . "\n";
        $header_string .= '           <td colspan="2"><table class="table-padding-2">' . "\n";
