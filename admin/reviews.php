...
?>
              <tr>
                <td colspan="5"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $reviews_split->display_count($reviews_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_REVIEWS); ?></td>
