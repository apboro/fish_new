...
// class constructor
  ...
  class productListingBoxFramed extends tableBox {
    function productListingBoxFramed($contents) {
      $this->table_parameters = 'class="imagetable" vocab="http://schema.org/" typeof="ItemList"';
