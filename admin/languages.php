...
?>
              <tr>
                <td colspan="3"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $languages_split->display_count($languages_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_LANGUAGES); ?></td>
