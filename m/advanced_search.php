...
<div class="contentContainer">
  <div class="contentText">
    <div class="advanced_search">
      ...
      <?php echo tep_draw_input_field('keywords', '') . tep_draw_hidden_field('search_in_description', '1'); ?>
      <span><?php echo tep_draw_button(IMAGE_BUTTON_SEARCH, 'search', null, 'primary'); ?></span>
      <span style="float: right; position:relative; top:12px;"><?php echo '<a href="' . tep_href_link(FILENAME_POPUP_SEARCH_HELP) . '" target="_blank" onclick="$(\'#helpSearch\').dialog(\'open\'); return false;">' . TEXT_SEARCH_HELP_LINK . '</a>'; ?></span>
