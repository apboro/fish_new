...
?>
              <tr>
                <td colspan="4"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $link_categories_split->display_count($link_categories_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_LINK_CATEGORIES); ?></td>
