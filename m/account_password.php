...
<div class="contentContainer" id="account_password">
	...
	?>
	<?php echo tep_draw_form('account_password', tep_href_link(FILENAME_ACCOUNT_PASSWORD, '', 'SSL'), 'post', 'onsubmit="return check_form(account_password);"', true) . 
		tep_draw_hidden_field('action', 'process'); ?>
	<div class="review_box">
    	<span class="inputRequirement" style="float: right;"><?php echo FORM_REQUIRED_INFORMATION; ?></span>
    	<span class="title"><?php echo MY_PASSWORD_TITLE; ?></span>
