...
// BOF manufacturers descriptions
  $manufacturers_split = new splitPageResults($_GET['page'], 800, $manufacturers_query_raw, $manufacturers_query_numrows);
...
?>
              <tr>
                <td colspan="2"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $manufacturers_split->display_count($manufacturers_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_MANUFACTURERS); ?></td>
