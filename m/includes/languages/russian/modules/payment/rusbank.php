...
*/
  ...
  define('MODULE_PAYMENT_RUS_BANK_TEXT_TITLE', 'Квитанция Сбербанка РФ');
  ...
  define('MODULE_PAYMENT_RUS_BANK_TEXT_EMAIL_FOOTER', "После сборки заказа вышлем квитанцию на оплату.");
