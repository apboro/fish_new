                  ...
                  <tr class="infoBoxContents">
                    <td><table class="table-padding-2">
                      <tr>
                        ...
                        <td valign="top" class="main"><?php echo tep_output_string_protected($reviews['reviews_text'])  . '<br><br><i>' . sprintf(TEXT_REVIEW_RATING, tep_image(DIR_WS_TEMPLATES . TEMPLATE_NAME . '/images/content/stars_' . $reviews['reviews_rating'] . '.gif', sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])), sprintf(TEXT_OF_5_STARS, $reviews['reviews_rating'])) . '</i>'; ?></td>
