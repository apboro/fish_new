	...
	?>
              					<tr>
                					<td colspan="6">
                  						<table class="table-padding-2">
                  							<tr>
                    	  						<td class="smallText top-valign"><?php echo $mail_split->display_count($mail_query_numrows, MAX_DISPLAY_SEARCH_RESULTS, $HTTP_GET_VARS['page'], TEXT_DISPLAY_NUMBER_OF_NEWSLETTERS); ?></td>
      ...
      if (is_object($nInfo)) {
        $heading[] = array('text' => '<b>' . $nInfo->title . '</b>');  
          $contents[] = array('align' => 'center', 'text' => '
          				...
          				</td></tr></table><table><tr><td class="main"><a href="' . tep_href_link(FILENAME_MM_RESPONSEMAIL, 'page=' . $HTTP_GET_VARS['page'] . '&nID=' . $nInfo->mail_id . '&action=test') . '">' . tep_image_button('button_test.gif', 'test') . '</a>
