...
//  define('HTTP_SERVER', 'http://yourfish.ru'); // eg, http://localhost - should not be empty for productive servers
  define('HTTPS_SERVER', 'https://yourfish.ru'); // eg, http://localhost - should not be empty for productive servers
//  define('HTTP_CATALOG_SERVER', 'http://yourfish.ru');
  define('HTTPS_CATALOG_SERVER', 'https://yourfish.ru');
  define('ENABLE_SSL_CATALOG', 'true'); // secure webserver for catalog module

   if (ENABLE_SSL_CATALOG=='true'){  
   define('HTTP_CATALOG_SERVER', HTTPS_CATALOG_SERVER);
   define('HTTP_SERVER',HTTPS_SERVER);
   }else{
    define('HTTP_SERVER', 'http://yourfish.ru');
    define('HTTP_CATALOG_SERVER', 'http://yourfish.ru');
               }
               
  define('DIR_FS_DOCUMENT_ROOT', '/var/www/html/yourfish.ru/'); // where the pages are located on the server
  define('DIR_WS_ADMIN', '/admin/'); // absolute path required
  define('DIR_FS_ADMIN', '/var/www/html/yourfish.ru/admin/'); // absolute pate required
  define('DIR_WS_CATALOG', '/'); // absolute path required
  define('DIR_FS_CATALOG', '/var/www/html/yourfish.ru/'); // absolute path required
  ...
  define('DIR_FS_CATALOG_IMAGES_PRO', DIR_FS_CATALOG . 'images/manuf/');
