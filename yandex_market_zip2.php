...
//$prod_ids=array (
//        'SMAG14-BBR',
//        'P21-GGT-77SP-MDR-402',
//        'lucky-36GTX',
//        '0481-1801',
//        'SSR09OTU',
//        'P21-SP-SYN-5-T01-071',
//        'edg95F-SBR',
//        'InbxS90F-LME',
//        'RL01C-461009',
//        'F11OTU',
...
//        'LJVIBS61-201',
//        'MetaxS95F-MHT',
//        'P21-GGT-77SP-MDR-404',
//        'P21-CAB-105SP-SR-721',
//        'MirgxD70F-PNT',
//        'MirgxS85F-TT',
//        '8375-S',
//        'ULC03-GAU',
...
//        '214207'
//);
//var_dump(implode(',',($prod_ids)); exit;
//print_r($prod_ids);
//exit;
//
...
'BFX1-SSDX'
        ...
        foreach ($products as $product) {
            ...
            $suppliers_id_list = array(18, 64, 56, 17, 25, 26, 28);  //18 - RS, 64 - bemal, 56- гретис, 26 - волжанка, 17 - гриффон, 25 - микадо, 15 - нормарк, выбираем поставщиков
    ...
    private function getOffer($product, $currencies, $clothes_cat, $param_names)
    {
        ...
        $after = "<currencyId>RUR</currencyId>
            <categoryId>Приманки для рыбалки</categoryId>
            {$images}
            <store>true</store>
            <pickup>true</pickup>
            <delivery>true</delivery>
            <dimensions>10/5/3</dimensions>
            {$weight}
            {$vendor}
            {$vendorCode}
            {$description}
...
if (strripos($_SERVER['REQUEST_URI'], '.zip') == false) {
    $filename = 'yandex_market2.gz';
} else {
    $filename = 'yandex_market2.zip';
}
...
shell_exec('cd ' . DIR_FS_CACHE . ' && rm -f yandex_market2.zip && zip yandex_market2.zip yandex_market_tmp2.xml');
shell_exec('cd ' . DIR_FS_CACHE . ' && rm -f yandex_market2.gz && gzip -c yandex_market_tmp2.xml > yandex_market2.gz');
