...
//email specific
//define('EMAIL_USERNAME', 'Email: ' . stripslashes($_SESSION['sc_customers_email_address']) . "\n\n");
//define('EMAIL_PASSWORD', 'Пароль: ' . stripslashes($_SESSION['sc_password']) . "\n\n");

define('EMAIL_USERNAME', 'Email: ' . stripslashes($email_address) . "\n\n");
define('EMAIL_PASSWORD', 'Пароль: ' . stripslashes($password) . "\n\n");


// CHECKOUT_SHIPPING

define('TABLE_HEADING_SHIPPING_ADDRESS', 'Имя, фамилия');
...
define('TABLE_HEADING_COMMENTS', 'Адрес доставки и комментарии');
...
define('TRY_TO_LOGIN_TEXT','<span style="font-size:1.2Em;font-weight:bold;">Вы уже зарегистрированы на сайте. Вам выслано письмо с ссылкой для входа</span>');
define('TRY_TO_LOGIN_MAIL','Для оформления заказа, перейдите, пожалуйста, по этой <a href="%s">ссылке</a>');
?>