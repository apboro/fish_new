...
//        $format_string = $this->currencies[$currency_type]['symbol_left'] . number_format(tep_round($number * $rate, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']) . ' ' . $this->currencies[$currency_type]['symbol_right']; 
        ...
        if (($this->discount_exist)&&($this->full_price>0)){
    	    $format_string.='<nobr><s class="cds">'.number_format(tep_round($this->full_price * $rate, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']). ' ' . $this->currencies[$currency_type]['symbol_right'].'</s></nobr>'.
		'<nobr><span class="cd">'.number_format(tep_round($number * $rate, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']) . ' ' . $this->currencies[$currency_type]['symbol_right'].'</span></nobr>'; 
    	    }else{
        ...
        $format_string = $this->currencies[$currency_type]['symbol_left'] ;
        //. number_format(tep_round($number, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']) . $this->currencies[$currency_type]['symbol_right'];
        if (($this->discount_exist)&&($this->full_price>0)){
    		$format_string.='<nobr><s class="cds">'.number_format(tep_round($this->full_price, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']) . $this->currencies[$currency_type]['symbol_right']. ' ' . $this->currencies[$currency_type]['symbol_right'].'</s></nobr>'.
		'<nobr><span class="cd">'.number_format(tep_round($number, $this->currencies[$currency_type]['decimal_places']), $this->currencies[$currency_type]['decimal_places'], $this->currencies[$currency_type]['decimal_point'], $this->currencies[$currency_type]['thousands_point']) . $this->currencies[$currency_type]['symbol_right'].'</span></nobr>';
        }else{
...
//    if ($this->discount_exist){echo 'Formated'.$format_string;exit;}
    ...
    function calculate_price($products_price, $products_tax, $quantity = 1) { 
 	      global $currency; 
	      $this->discount_exist=($products_price!=$this->origin_price);
 	      $this->full_price=tep_round(tep_add_tax($this->origin_price, $products_tax), $this->currencies[$currency]['decimal_places']) * $quantity; 
    ...
    function display_price($products_price, $products_tax, $quantity = 1, $currency_type = DEFAULT_CURRENCY) {
      global $customer_id;
      $this->origin_price=$products_price;
