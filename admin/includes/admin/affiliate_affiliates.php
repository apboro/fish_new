...
?>
              <tr>
                <td colspan="6"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $affiliate_split->display_count($affiliate_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_AFFILIATES); ?></td>
