...
// define the content used in the project
  ...
  define('CONTENT_mapa', 'map');
  define('CONTENT_baidar', 'baidar');
  ...
  define('CONTENT_SEARCH2', 'results');
  ...
  define('CONTENT_RELATED_PRODUCTS', 'related_products');
  define('CONTENT_SHOPPING_CART', 'shopping_cart');
  define('CONTENT_SPECIALS', 'specials');
  define('CONTENT_SEARCH2', 'search2');
  define('CONTENT_POPS', 'pops');
...
// define the filenames used in the project
  ...
  define('FILENAME_PRODUCT_NESTED', 'product_listing_nested.php');
  ...
  define('FILENAME_CONTENT_RELATED_PRODUCTS', CONTENT_RELATED_PRODUCTS . '.php');
  define('FILENAME_SHOPPING_CART', CONTENT_SHOPPING_CART . '.php');
  define('FILENAME_SPECIALS', CONTENT_SPECIALS . '.php');
  define('FILENAME_SEARCH2', CONTENT_SEARCH2 . '.php');
  define('FILENAME_POPS', CONTENT_POPS . '.php');
...
// Added for Xsell Products Mod
  ...
  define('FILENAME_PRODUCT_LISTING_COL_POPS', 'product_listing_col_pops.php');
...
define('FILENAME_PRODUCT_QUESTION','pq.php');
...
define('FILENAME_POPS','pops.php');
define('FILENAME_SEARCH2','search2.php');
?>