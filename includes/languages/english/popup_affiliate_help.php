...
define('TEXT_SUMMARY', 'Click [?] to read help text.');
...
define('TEXT_CLICKTHROUGH_RATE_HELP', '<b>Pay per click:</b> pay for unique click.');
define('TEXT_PAY_PER_SALE_RATE_HELP', '<b>Pay per sale:</b> pay for every sale.');
