...
?>
<div class="contentContainer" id="account_history">
    ...
    <?php
        ...
        <div class="review_box">
        	<div class="content_box">	
                <span class="title"><?php echo TEXT_ORDER_NUMBER . ' ' . $history['orders_id'] . ' <span class="contentText">(' . $history['orders_status_name'] . ')</span>'; ?>
                </span>
        ...
        <div class="contentText">
    		<p style="float: right;"><?php echo TEXT_RESULT_PAGE . ' <span class="mj-pagination">' . $history_split->display_links(MAX_DISPLAY_PAGE_LINKS, 
				tep_get_all_get_params(array('page', 'info', 'x', 'y'))); ?></span></p>
