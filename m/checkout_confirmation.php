...
<div class="contentContainer">
	<div class="mj-checkoutprogress">
          ...
          <span class="mj-step1"><?php echo '<a href="' . tep_href_link(FILENAME_CHECKOUT_PAYMENT, '', 'SSL') . '" 
		  class="checkoutBarFrom">' . CHECKOUT_BAR_PAYMENT . '</a>'; ?></span>
          <span class="mj-step"><?php echo CHECKOUT_BAR_CONFIRMATION; ?></span>
    </div>
  
  <div class="review_box">
  	<span class="title"><?php echo HEADING_SHIPPING_INFORMATION; ?></span>
...
?>
        ...
        <td width="<?php echo (($sendto != false) ? '70%' : '100%'); ?>" valign="top"><table class="table-padding-2">
