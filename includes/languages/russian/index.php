...
define('TEXT_MAIN', '&nbsp;');
define('TABLE_HEADING_NEW_PRODUCTS', 'Новинки');
define('TABLE_HEADING_VIDEOBOX', 'Интересное видео о рыбалке');
...
if ( ($category_depth == 'products') || (isset($_GET['manufacturers_id'])) ) {
  ...
  define('TEXT_NO_PRODUCTS', 'Нет ни одной снасти в этом разделе.');
  define('TEXT_NO_PRODUCTS2', 'Нет ни одной снасти данного производителя.');
  define('TEXT_NUMBER_OF_PRODUCTS', 'Количество снастей: ');
  ...
  define('HEADING_TITLE', 'Рыболовный интернет-магазин: товары почтой и курьером по Москве.');
} elseif ($category_depth == 'nested') {
  define('HEADING_TITLE', 'Разделы');
}
  define('HEADING_CUSTOMER_GREETING', 'Интернет-магазин рыболовного снаряжения YourFish.ru');
...
// BOF: Lango added for Featured Products
  ...
  define('TABLE_HEADING_FEATURED_PRODUCTS_CATEGORY', 'Рекомендуемые снасти раздела %s'); 
