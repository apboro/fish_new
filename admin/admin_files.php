...
?>
              <tr>
                <td colspan="2"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo TEXT_COUNT_FILES . $file_count; ?></td>
                    <td class="smallText top-valign" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_ADMIN_FILES, 'cID=' . $_GET['cPath']) . '">' . tep_image_button('button_back.gif', IMAGE_BACK) . '</a>&nbsp<a href="' . tep_href_link(FILENAME_ADMIN_FILES, 'cPath=' . $_GET['cPath'] . '&action=store_file') . '">' . tep_image_button('button_admin_files.gif', IMAGE_INSERT_FILE) . '</a>'; ?>&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
...
?>
              <tr>
                <td colspan="3"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php  echo TEXT_COUNT_BOXES . $boxnum; ?></td>
                    <td class="smallText top-valign" align="right">&nbsp;</td>
                  </tr>
                </table></td>
              </tr>
            </table>
