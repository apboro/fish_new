...
define('TEXT_EASYPOPULATE_LABEL_OG_TITLE','OG title');
define('TEXT_EASYPOPULATE_LABEL_OG_DESCRIPTION','OG описание');
define('TEXT_EASYPOPULATE_LABEL_OG_IMAGE','OG изображение');
define('TEXT_EASYPOPULATE_LABEL_TK_TITLE','TK title');
define('TEXT_EASYPOPULATE_LABEL_TK_DESCRIPTION','TK описание');
define('TEXT_EASYPOPULATE_LABEL_TK_IMAGE','TK изображение');
...
define('TEXT_EASYPOPULATE_LABEL_SUPPLIER','поставщик');
...
define('TEXT_EASYPOPULATE_LABEL_BARCODE','Штрихкод');
