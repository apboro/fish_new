...
?>
              <tr>
                <td colspan="2"><table class="table-padding-2">
                  <tr>
                    <td class="smallText top-valign"><?php echo $authors_split->display_count($authors_query_numrows, MAX_PROD_ADMIN_SIDE, $_GET['page'], TEXT_DISPLAY_NUMBER_OF_AUTHORS); ?></td>
