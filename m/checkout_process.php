...
// load the before_process function from the payment modules
  ...
  $sql_data_array = array('customers_id' => $customer_id,
	...
	if (isset($_SESSION['order_addon'])){
            $sql_data_array['addon']=serialize($_SESSION['order_addon']);
            }
    tep_db_perform(TABLE_ORDERS, $sql_data_array);
    unset($_SESSION['order_addon']);
...
/*----order addon hostory---*/
if ($_SESSION['order_addon_comment']){
  $sql_data_array = array('orders_id' => $insert_id,
                          'orders_status_id' => $order->info['order_status'],
                          'date_added' => 'now()',
                          'customer_notified' => 0,
                          'customer_visible'=>0,
                          'comments' => tep_db_input($_SESSION['order_addon_comment']));
  tep_db_perform(TABLE_ORDERS_STATUS_HISTORY, $sql_data_array);
    unset($_SESSION['order_addon_comment']);
    }
/*----order addon hostory---*/
